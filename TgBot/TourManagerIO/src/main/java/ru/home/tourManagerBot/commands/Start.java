...
public class Start {
    ...
    public SendMessage run(Update update){
        ...
        //удаляет данные пользователя по ключу, чтобы могли добавлять нового пользователя
        BotImplementation.userState.remove(update.getMessage().getFrom().getUserName());
